...
quantiles %>%
    ...
    geom_text(aes(y = quantile975, label = median), vjust=-1.3, size = 3) +
    ylim(0,1300) +
    xlab('Dagsetning') + 
...
quantiles_outp %>%
    ...
    ylab('Fjöldi') +
    ylim(0,20) +
    ggtitle('Fjöldi koma á göngudeild á hverjum degi')
```
