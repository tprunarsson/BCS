...
numericInput("hospital_prob_input", 'Líkur á innlögn',
            min = 0, max = 1, step = 0.001, value = 0.016)
numericInput("icu_prob_input", 'Líkur á gjörgæsluinnlögn',
            min = 0, max = 1, step = 0.001, value = 0.02)
hr()
...
ferguson_data_logistic <- run_ferguson_simulation_new(infected_distr_logistic, los_dist_logistic(), age_dist_logistic(), input$hospital_prob_input, input$icu_prob_input)
