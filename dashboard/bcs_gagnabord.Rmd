...
data_length_of_stay <- bcs_data$data_length_of_stay %>% recode_states()
data_all_simulation <- bcs_data$data_all_simulation

get_and_save_if_new_data(bcs_data)
...
sliderInput('dagsetning_sk', 'Dagsetning:', min = start_date, max = max(data_all_simulation$date),
