...
# Functions
load_git_data <- function(type = c('length_of_stay_with_imputed', 'length_of_stay_empirical', 'transition_matrix'),
                          data_folder = 'dashboard/input') {
  # Create URLs to csv files
  root_path <- 'https://raw.githubusercontent.com/tprunarsson/BCS/master'
  files <- sprintf('%s_%s.csv', seq.Date(from = as.Date('2020-04-02'), Sys.Date(), by = 1), type)
...
end_date <- max(data_length_of_stay$date)
...
Skýrslur {data-icon="fa-file-alt"}
=======================================================================
