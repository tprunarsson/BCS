...
numericInput("hospital_prob_input", 'Líkur á innlögn',
            min = 0, max = 1, step = 0.001, value = 0.005)
hr()

#Aldursdreifing (4. bylgja frá 23. júlí)
radioButtons('logistic_aldur_val', 'Aldursdreifing', choices = c('4. bylgja', 'Covid-19', 'Covid-19 án fyrstu bylgju', 'Þjóðar', 'Skv. stillingu:'))
conditionalPanel(
...
age_dist_logistic <- reactive({
  ...
  else if (input$logistic_aldur_val == '4. bylgja')
   aldur_faraldur4_logistic
...
ferguson_data_logistic <- run_ferguson_simulation_new(infected_distr_logistic, los_dist_logistic(), age_dist_logistic(), input$hospital_prob_input)
