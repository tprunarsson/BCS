...
path_to_prop <- paste0('../lsh_data/',current_date,'_prop_outpatient_clinic.csv')
...
Hlutfall sjúklinga í heimaeinangrun sem komu á göngudeild frá og með `r format(date_for_calculation, "%d-%m-%Y")` til og með `r format(current_date-1, "%d-%m-%Y")` er `r round(prop_outpatient_clinic_last_week, 4)*100`%.
