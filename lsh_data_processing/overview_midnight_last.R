...
save(sys_covid_all,sim_home,sim_ward,sim_icu,sys_released,sim_total_age_groups,sim_total_state_worst,sim_dfd_dis,sys_turn,sim_hosp_turn,file=overview_midnight_path)
