...
path_data_simulation <-'../output/2020-04-02_covid_simulation.csv'
...
simulation_gjorgaesla <- simulation[simulation_gjorgaesla$state=="Gjörgæsla",]
#Compute medians to display on plot
